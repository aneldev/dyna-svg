(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("dyna-svg", [], factory);
	else if(typeof exports === 'object')
		exports["dyna-svg"] = factory();
	else
		root["dyna-svg"] = factory();
})(this, function() {
...
class DynaSvg extends React.Component {
    render() {
        const { className, src, style } = this.props;
        let props = Object.assign({}, this.props);
        delete props.className;
        delete props.src;
        return (React.createElement("div", Object.assign({ className: className || 'dyna-svg-defaults' }, props, { style: Object.assign({}, (style || {}), { display: 'inline-block', fontSize: 0 }), dangerouslySetInnerHTML: { __html: src } })));
    }
}
exports.DynaSvg = DynaSvg;
