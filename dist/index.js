...
class DynaSvg extends React.Component {
    render() {
        ...
        delete props.width;
        delete props.height;
        return (React.createElement("div", Object.assign({}, props, { style: Object.assign({}, (style || {}), { display: 'inline-block', width: width + 'px', height: height + 'px' }), dangerouslySetInnerHTML: { __html: src } })));
    }
}
